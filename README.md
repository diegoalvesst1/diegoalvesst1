...
**`Desenvolvedora FullStack/Automação`**
...
🤖 Automações: Scripts e bots projetados para simplificar tarefas repetitivas e interagir com sistemas de forma inteligente.

💻 Projetos Full Stack: Aplicações web desenvolvidas para resolver desafios do dia a dia, conectando interfaces amigáveis a backends estruturados.

🚀 Evolução Contínua: Códigos que refletem meu aprendizado e testes práticos de novas tecnologias.
